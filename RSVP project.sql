...
-- Finding tables having null values
select *
from movie;
...
## There are null values in country_nulls, worldwide_gross_income_nulls, language_null, production_company_nulls
...
--  Finding the total number of movies released each year. How does the trend look month wise.
...
Group by country 
having year = 2019;
/* India  released 1007 movies in 2019
...
/* Action has the highest duration time of 112 minutes. Drama has 106 minutes.
...
/* Rating 7 has the highest number of movie count.
...
-- We will also try your hand at median rating and check whether the ‘median rating’ column gives any significant insights.
